...
export function composeVerdict({ config, judged, root, baseline, tree, session, reason, prompts, skipped, unjudged, notifyOnly = null }) {
  ...
  return {
    ...
    baseline,
    tree,
    summary: { files: files.length, added, removed, skipped },
